...
public class DotParser implements PsiParser, LightPsiParser {
    ...
    public static boolean ID(PsiBuilder b, int l) {
        ...
        if (!r) {
            r = consumeToken(b, QUOTED_ANY);
        }
        if (!r) {
            r = consumeToken(b, HTML_ID);
        }
        if (!r) {
            r = consumeToken(b, NUMERAL_ID);
        }
        exit_section_(b, l, m, r, false, null);
        return r;
    }
    ...
    public static boolean a_list(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "a_list")) {
            return false;
        }
        boolean r;
    ...
    private static boolean a_list_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "a_list_0")) {
            return false;
        }
        boolean r;
    ...
    private static boolean a_list_0_3(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "a_list_0_3")) {
            return false;
        }
        a_list_0_3_0(b, l + 1);
        return true;
    ...
    private static boolean a_list_0_3_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "a_list_0_3_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean a_list_0_4(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "a_list_0_4")) {
            return false;
        }
        a_list(b, l + 1);
        return true;
    ...
    public static boolean attr_list(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "attr_list")) {
            return false;
        }
        if (!nextTokenIs(b, BRACHET_LEFT)) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean attr_list_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "attr_list_1")) {
            return false;
        }
        a_list(b, l + 1);
        return true;
    ...
    private static boolean attr_list_3(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "attr_list_3")) {
            return false;
        }
        attr_list(b, l + 1);
        return true;
    ...
    public static boolean attr_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "attr_stmt")) {
            return false;
        }
        boolean r;
    ...
    private static boolean attr_stmt_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "attr_stmt_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean attr_stmt_0_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "attr_stmt_0_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
        ...
        if (!r) {
            r = consumeToken(b, NODE_);
        }
        if (!r) {
            r = consumeToken(b, EDGE_);
        }
        exit_section_(b, m, null, r);
        return r;
    }
    ...
    public static boolean character(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "character")) {
            return false;
        }
        boolean r;
    ...
    public static boolean comment_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "comment_stmt")) {
            return false;
        }
        if (!nextTokenIs(b, "<comment stmt>", COMMENT, MULTILINE_COMMENT)) {
            return false;
        }
        boolean r;
    ...
    public static boolean compass_pt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "compass_pt")) {
            return false;
        }
        if (!nextTokenIs(b, COMPASS)) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    static boolean dotFile(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dotFile")) {
            return false;
        }
        ...
        while (true) {
            ...
            if (!empty_element_parsed_guard_(b, "dotFile", c)) {
                break;
            }
    ...
    private static boolean dotFile_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dotFile_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    public static boolean dotgraph_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dotgraph_stmt")) {
            return false;
        }
        boolean r;
    ...
    private static boolean dotgraph_stmt_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dotgraph_stmt_0")) {
            return false;
        }
    ...
    private static boolean dotgraph_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dotgraph_stmt_1")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean dotgraph_stmt_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dotgraph_stmt_2")) {
            return false;
        }
        ID(b, l + 1);
        return true;
    ...
    private static boolean dotgraph_stmt_4(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "dotgraph_stmt_4")) {
            return false;
        }
        stmt_list(b, l + 1);
        return true;
    ...
    public static boolean edgeRHS(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "edgeRHS")) {
            return false;
        }
        if (!nextTokenIs(b, EDGE_OP)) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean edgeRHS_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "edgeRHS_1")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean edgeRHS_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "edgeRHS_2")) {
            return false;
        }
        edgeRHS(b, l + 1);
        return true;
    ...
    public static boolean edge_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "edge_stmt")) {
            return false;
        }
        boolean r;
    ...
    private static boolean edge_stmt_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "edge_stmt_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean edge_stmt_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "edge_stmt_2")) {
            return false;
        }
        attr_list(b, l + 1);
        return true;
    ...
    public static boolean node_id(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "node_id")) {
            return false;
        }
        boolean r;
    ...
    private static boolean node_id_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "node_id_1")) {
            return false;
        }
        port(b, l + 1);
        return true;
    ...
    public static boolean node_stmt(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "node_stmt")) {
            return false;
        }
        boolean r;
    ...
    private static boolean node_stmt_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "node_stmt_1")) {
            return false;
        }
        attr_list(b, l + 1);
        return true;
    ...
    private static boolean port_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "port_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean port_0_2(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "port_0_2")) {
            return false;
        }
        port_0_2_0(b, l + 1);
        return true;
    ...
    private static boolean port_0_2_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "port_0_2_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean port_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "port_1")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean stmt_3(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "stmt_3")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    public static boolean stmt_list(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "stmt_list")) {
            return false;
        }
    ...
    private static boolean stmt_list_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "stmt_list_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean stmt_list_0_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "stmt_list_0_1")) {
            return false;
        }
        consumeToken(b, EOS);
        return true;
    ...
    public static boolean sub_graph(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "sub_graph")) {
            return false;
        }
        if (!nextTokenIs(b, "<sub graph>", CURLY_BRACHET_LEFT, SUB_GRAPH_)) {
            return false;
        }
        boolean r;
    ...
    private static boolean sub_graph_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "sub_graph_0")) {
            return false;
        }
        sub_graph_0_0(b, l + 1);
        return true;
    ...
    private static boolean sub_graph_0_0(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "sub_graph_0_0")) {
            return false;
        }
        boolean r;
        Marker m = enter_section_(b);
    ...
    private static boolean sub_graph_0_0_1(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "sub_graph_0_0_1")) {
            return false;
        }
        ID(b, l + 1);
        return true;
    ...
    public static boolean symbol(PsiBuilder b, int l) {
        if (!recursion_guard_(b, l, "symbol")) {
            return false;
        }
        boolean r;
        ...
        if (!r) {
            r = consumeToken(b, CURLY_BRACHET_LEFT);
        }
        if (!r) {
            r = consumeToken(b, CURLY_BRACKET_RIGHT);
        }
        exit_section_(b, l, m, r, false, null);
        return r;
    }
